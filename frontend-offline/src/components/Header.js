...
const Header = () => {
    ...
    const { hotelData, selectedService, setSelectedService, weatherData, flightsData, services, handleServiceReset, handleServiceClick } = useContext(AppContext);
    ...
    return (
        <header style={{ height:'32.9375rem' }}>
            {hotelData && <div style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/images/hotel/${hotelData["landing"]["private_hotel_logo"]})`, backgroundSize: 'cover', height: '18.3125rem' }}
